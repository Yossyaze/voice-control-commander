  ...
  return (
    <div className="w-72 bg-white flex flex-col h-full border-l border-gray-200 font-sans shadow-xl z-20 overflow-hidden">
      ...
      <div className="h-12 px-4 border-b border-gray-200 bg-white flex justify-between items-center flex-shrink-0">
        <h2 className="text-xs font-bold text-gray-500 tracking-wider uppercase">Properties</h2>
        {!isFullscreen && (
          <button onClick={onEnterFullscreen} className="p-1.5 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded" title="Maximize">
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <div className="space-y-3">
          <label className="text-xs font-bold text-gray-400 uppercase tracking-wider block">Environment</label>
          ...
          <div className="space-y-2">
             ...
             <div>
                  ...
                  />
                  <button onClick={onClearBackgroundImage} className="text-[10px] text-gray-400 hover:text-red-500 hover:underline w-full text-center mt-1">Clear Background</button>
             </div>
          </div>
        </div>
        ...
        {!selectionType || selectionType === 'stroke' ? (
             <div className={`space-y-4 pt-4 border-t border-gray-100 ${!isActionSelected ? 'opacity-50 pointer-events-none grayscale' : ''}`}>
                 <div className="flex items-center justify-between">
                     <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">Action Properties</label>
                 ...
                 <div className="space-y-4">
                     ...
                     <div className="grid grid-cols-2 gap-2 bg-gray-50 p-2 rounded border border-gray-200">
                         <div>
                             <span className="text-[10px] text-gray-400 block uppercase">Start X</span>
                             <span className="font-mono text-gray-700 text-sm">{absoluteX !== undefined ? formatCoord(absoluteX) : '--'}</span>
                         </div>
                         <div>
                             <span className="text-[10px] text-gray-400 block uppercase">Start Y</span>
                     ...
                     <div className="flex flex-col items-center space-y-2">
                         <span className="text-[10px] text-gray-500">Fine Tune Position</span>
                     ...
                     <div>
                         <div className="flex justify-between mb-1">
                             ...
                             <span className="text-xs font-mono bg-gray-100 px-1.5 rounded text-gray-600">{duration.toFixed(1)}s</span>
                         </div>
                         <input 
                             type="range" 
                             min="0.1" 
                     ...
                     <div>
                        <div className="flex justify-between mb-1">
                             <label className="text-xs font-medium text-gray-600">Scale / Length</label>
            ...
            <div className="space-y-4 pt-4 border-t border-gray-100">
                 <div className="flex items-center justify-between">
                    <label className="text-xs font-bold text-gray-400 uppercase tracking-wider">Wait Properties</label>
                    <span className="text-[10px] text-white bg-blue-500 px-2 py-0.5 rounded-full font-bold">Selected</span>
                 </div>
                 <div className="bg-blue-50 p-4 rounded-md border border-blue-100">
                    <label className="block text-xs font-semibold text-blue-900 mb-2">Wait Duration</label>
                    <div className="flex items-center space-x-2">
                        ...
                        />
                        <span className="text-xs text-blue-700 font-medium whitespace-nowrap">seconds</span>
                    </div>
            ...
            >
                {isPlaying ? (
                    ...
                    <>
                        ...
                        {isActionSelected ? 'Play Action' : 'Play All'}
                    </>
                )}
            </button>
